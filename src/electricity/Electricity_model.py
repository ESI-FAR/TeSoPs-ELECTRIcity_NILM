...
from .model_helpers import LayerNorm
from .model_helpers import PositionalEmbedding
from .model_helpers import TransformerBlock
...
class TransformerModel(nn.Module):
    def __init__(self, args):
        ...
        self.conv = nn.Conv1d(
            in_channels=1, out_channels=self.hidden, kernel_size=5, stride=1, padding=2, padding_mode="replicate"
        )
